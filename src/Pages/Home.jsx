    ...
    <>
      <div className="w-[90vw] mx-auto flex justify-between items-center py-5">
        ...
        <div className="text-white">
          <Link className="border-neutral-100 border py-3 px-4 rounded-lg  transition-all duration-300 ease-in-out bg-none text-white hover:bg-white hover:text-black ">
            Log in
          </Link>
        </div>
      </div>

      <div className="flex flex-wrap justify-center gap-4 mt-10 w-[90vw] mx-auto">
        {movies.map((movie) => (
